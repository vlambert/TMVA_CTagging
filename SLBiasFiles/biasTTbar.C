  		...
  		myfile.open (filename.c_str());
 			...
 			//for(int l = 0; l<1; l++ ){// loop on pt/eta bins defined in xml
			  //int index = j*3;
				...
				//double bias = (double)((entries[indexb][l]/(entries[k][l]+entries[k+3][l]+entries[k+6][l]+entries[k+9][l]+entries[k+12][l]+entries[k+15][l]+entries[k+18][l]+entries[k+21][l]+entries[k+24][l]))));  // N_cat_flav / Nflav
