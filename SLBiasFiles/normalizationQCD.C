// ====================================================================== //
//                                                                        //                       
//  Create normalization weights from QCD to remove category information  //
//                                                                        //
// ====================================================================== // 
...
void normalizationQCD(){
  ...
  string dir = "/scratch/vlambert/Phys14AOD/QCD_13TeV_defaultIVF";
  ...
  for(int j=0; j<9; j++){//loop on categories	
	...
	int index = j*3;
	int indexb = k+j*3;
	double bias = (double)(1./entries[indexb][l]); 
